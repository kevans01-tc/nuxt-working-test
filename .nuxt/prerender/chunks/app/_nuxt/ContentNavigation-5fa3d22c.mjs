import { useSSRContext, defineComponent, toRefs, computed, useSlots, toRef, isRef, h } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/vue/index.mjs';
import { u as useContentDisabled, a as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-fc600b65.mjs';
import { d as useNuxtApp, b as useRuntimeConfig } from '../server.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-2191e472.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-5fa3d22c.mjs.map
