import { mergeProps, useSSRContext } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/vue/index.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "empty-layout-container" }, _attrs))}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(".nuxt/layouts.empty.layout.2d9af7e1.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const layouts_empty_layout_2d9af7e1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { layouts_empty_layout_2d9af7e1 as default };
//# sourceMappingURL=layouts.empty.layout.2d9af7e1-ebbd653f.mjs.map
