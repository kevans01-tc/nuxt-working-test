...
import { mergeProps, withCtx, createTextVNode, createVNode, useSSRContext } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/vue/index.mjs';
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_WLButton, {
          variant: "plain",
          href: "/product-catalog/categories/current-category"
        }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`View a category`);
            } else {
              return [
                createTextVNode("View a category")
              ];
            }
          }),
          _: 1
        }, _parent2, _scopeId));
        _push2(`</section><section${_scopeId}><div${_scopeId}>categories index</div></section>`);
      } else {
        return [
          ...
          createVNode("section", null, [
            createVNode("div", null, "categories index")
          ])
        ];
      }
    }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/product-catalog/categories/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { index as default };
//# sourceMappingURL=index-505aec9f.mjs.map
