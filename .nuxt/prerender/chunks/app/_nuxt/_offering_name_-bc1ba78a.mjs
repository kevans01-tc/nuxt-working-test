...
import { mergeProps, withCtx, unref, createVNode, toDisplayString, useSSRContext } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/vue/index.mjs';
import { ssrRenderComponent, ssrInterpolate } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/vue/server-renderer/index.mjs';
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "subsection" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</section><section${_scopeId}><div${_scopeId}>offerings ${ssrInterpolate(unref(route).params.offering_name)}</div></section>`);
          } else {
            return [
              ...
              createVNode("section", null, [
                createVNode("div", null, "offerings " + toDisplayString(unref(route).params.offering_name), 1)
              ])
            ];
          }
        }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/product-catalog/offerings/[offering_name].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_offering_name_-bc1ba78a.mjs.map
