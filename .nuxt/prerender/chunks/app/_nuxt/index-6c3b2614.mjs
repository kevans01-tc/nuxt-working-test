    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_WLButton, {
          variant: "plain",
          href: "/product-catalog/offerings/current-offering"
        }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`View an offering`);
            } else {
              return [
                createTextVNode("View an offering")
              ];
            }
          }),
          _: 1
        }, _parent2, _scopeId));
        _push2(`</section><section${_scopeId}><div${_scopeId}>offerings index</div></section>`);
      } else {
        return [
          ...
          createVNode("section", null, [
            createVNode("div", null, "offerings index")
          ])
        ];
      }
    }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/product-catalog/offerings/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { index as default };
//# sourceMappingURL=index-6c3b2614.mjs.map
