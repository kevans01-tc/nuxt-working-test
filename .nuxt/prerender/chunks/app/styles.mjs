...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.e0ff0cd2.mjs').then(interopDefault),
  ...
  ".nuxt/layouts.default.layout.6aca7226.vue": () => import('./_nuxt/layouts.default.layout.6aca7226-styles.1ff8d53d.mjs').then(interopDefault)
};
