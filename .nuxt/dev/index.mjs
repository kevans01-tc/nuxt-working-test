globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { defineEventHandler, handleCacheHeaders, isEvent, createEvent, getRequestHeader, splitCookiesString, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, lazyEventHandler, getQuery as getQuery$1, getCookie, createError, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, getResponseStatusText } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/@unhead/ssr/dist/index.mjs';
...
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/ufo/dist/index.mjs';
...
import { extname } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/pathe/dist/index.mjs';
...
import { postprocess, preprocess } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/micromark/dev/index.js';
...
import { markdownLineEnding, markdownSpace } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/micromark-util-chunked/dev/index.js';
...
import { normalizeUri } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/micromark-util-sanitize-uri/dev/index.js';
...
import { version, unref } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/karenevans/Documents/nuxt-working-test/node_modules/@unhead/shared/dist/index.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/karenevans/Documents/nuxt-working-test/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _YJz7eL1QZN = (function(nitro) {
...
const parseMarkdown = async (md, opts = {}) => {
  if (!moduleOptions) {
    moduleOptions = await import(
      'file:///Users/karenevans/Documents/nuxt-working-test/.nuxt/mdc-imports.mjs'
      /* @vite-ignore */
    ).catch(() => ({}));
  }
...
const _lazy_YxxFfz = () => Promise.resolve().then(function () { return renderer$1; });
...
const handlers = [
  ...
  { route: '/api/_content/cache.json', handler: _aHDDrx, lazy: false, middleware: false, method: "get" },
...
const getClientManifest = () => import('file:///Users/karenevans/Documents/nuxt-working-test/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/karenevans/Documents/nuxt-working-test/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
