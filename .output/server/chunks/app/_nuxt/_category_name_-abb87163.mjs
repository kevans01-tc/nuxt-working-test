      ...
      _push(ssrRenderComponent(_component_NuxtLayout, mergeProps({ name: "subsection" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</section><section${_scopeId}><div${_scopeId}>category ${ssrInterpolate(unref(route).params.category_name)}</div></section>`);
          } else {
            return [
              ...
              createVNode("section", null, [
                createVNode("div", null, "category " + toDisplayString(unref(route).params.category_name), 1)
              ])
            ];
          }
        }),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/product-catalog/categories/[category_name].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_category_name_-abb87163.mjs.map
